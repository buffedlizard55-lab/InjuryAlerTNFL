...
- `data/archive.json` — 40 game-specific source-checked examples, each with dated claims and official league/team links. `data/review.json` — fifteen separately flagged source issues. Tracked `data/live.json` and `data/scoreboard.json` are honest *not yet checked* fallbacks for first deployment.
